...
app.post('/pstn', function (request, response) {
    ...
    gather.say({voice: 'alice', language: 'es-MX'}, 'Nos estamos conectando a tu entrevista en vivo. Esta entrevista será grabada. Al participar en esta entrevista estás aceptando los Términos de Servicio y Políticas de Privacidad de Wepow.');
    twiml.redirect('/pstn');
